...
originContent: >-
  ...
  ![](http://file.mspring.org/images/blog/5da3bccecd4a368617b723af2d6a4d66)
  ...
  ![](http://file.mspring.org/images/blog/14c5b97ff15828102a7f4f382fceafe6)
  ...
  ![](http://file.mspring.org/images/blog/b226ac77f29b72e16281c0005f346369)


  #### 多行、多列切割


  ![](http://file.mspring.org/images/blog/83045a1b6f5ee169e6a6502800f71fcd)
  ...
  ![](http://file.mspring.org/images/blog/6ea6ef1ab86e35988b33c054f0c31df1)
  ...
  ![](http://file.mspring.org/images/blog/622b6c570f6862e90a1d483e99807375)
  ...
  ![](http://file.mspring.org/images/blog/c448cb53f68834cc2aaf0ee49c822973)
  ...
  ![](http://file.mspring.org/images/blog/50c66485033fffebbb0be0928f040cff)
  ...
  ![](http://file.mspring.org/images/blog/1ccb42dbca0cab4cf0bd73a25bf16265)
  ...
  ![](http://file.mspring.org/images/blog/4a67a286b05a71ab8642754ee75006f1)
  ...
  ![](http://file.mspring.org/images/blog/e683e47cb930394065857b920ac8795d)
  ...
  ![](http://file.mspring.org/images/blog/19758d867fda3c79ad81868751528714)


  生成结果如下：

  ![](http://file.mspring.org/images/blog/edaf881741daa6c1b5dcc4b0805c5fd2)
...
![](http://file.mspring.org/images/blog/5da3bccecd4a368617b723af2d6a4d66!detail)

### 二值化
二值化就是将图像中灰度值大于某个`临界灰度值`的像素点设置为灰度最大值，灰度值小于某个`临界灰度值`的像素点设置为灰度最小值。这样`图像中就只会出现黑和白两种颜色`。合理的二值化能够减少被识别图像中的干扰因素，对于提升识别效果也是有很大的帮助的。例如下图，在二值化之前图片是有水印的，二值化之后能将水印直接去掉。

![](http://file.mspring.org/images/blog/14c5b97ff15828102a7f4f382fceafe6!detail)
...
![](http://file.mspring.org/images/blog/b226ac77f29b72e16281c0005f346369!detail)

#### 多行、多列切割

![](http://file.mspring.org/images/blog/83045a1b6f5ee169e6a6502800f71fcd!detail)

### 图片旋转
如果图片中的文字是倾斜的，会导致Tesseract的行数据分割不准确，严重影响ocr的效果，所以在识别之前可以先旋转图片，使文字保持水平。

![](http://file.mspring.org/images/blog/6ea6ef1ab86e35988b33c054f0c31df1!detail)
...
![](http://file.mspring.org/images/blog/622b6c570f6862e90a1d483e99807375!detail)
...
![](http://file.mspring.org/images/blog/c448cb53f68834cc2aaf0ee49c822973!detail)
...
![](http://file.mspring.org/images/blog/50c66485033fffebbb0be0928f040cff!detail)
...
![](http://file.mspring.org/images/blog/1ccb42dbca0cab4cf0bd73a25bf16265!detail)
...
![](http://file.mspring.org/images/blog/4a67a286b05a71ab8642754ee75006f1!detail)

### 完成训练
在完成box文件的编辑之后就可以使用box文件进行训练了，如下图：

![](http://file.mspring.org/images/blog/e683e47cb930394065857b920ac8795d!detail)
...
![](http://file.mspring.org/images/blog/19758d867fda3c79ad81868751528714!detail)

生成结果如下：
![](http://file.mspring.org/images/blog/edaf881741daa6c1b5dcc4b0805c5fd2!detail)
